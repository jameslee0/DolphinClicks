...
def dolphin_classifier(data_directory):
    ...
    for date in GgTrainDates:
        GgTrainingData = Gg_split_data[date]
    for date in GgTestDates:
        GgTestingData = Gg_split_data[date]
    for date in LoTrainDates:
        LoTrainingData = Lo_split_data[date]
    for date in LoTestDates:
        LoTestingData = Lo_split_data[date]
